		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NF-e de Retorno de Remessa ",
									"targetURL": "#mrscombrzmmdieselnfretorno-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrscombrzmmdieselnfretorno-display": {
								"semanticObject": "mrscombrzmmdieselnfretorno",
								"action": "display",
								"description": "NF-e de Retorno de Remessa ",
								"title": "NF-e de Retorno de Remessa ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrs.com.br.zmmdieselnfretorno",
									"url": sap.ui.require.toUrl("mrs/com/br/zmmdieselnfretorno")
								}
							}
						}
					}
